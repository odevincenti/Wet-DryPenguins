...
//#TODO: Arreglar esta funcion (la hice muy x arriba)
HandlerOutput_t H_autocalibrate_min(char input){
    bool received = false;
#ifdef VERBOSE
    PC.print("CALIBRATING MINUTE...\n");
#endif
    send_command_to_msp('C');
    received = receive_answer_from_msp();
    delay(60000);
    send_command_to_msp('>');
    received = receive_answer_from_msp();
    return H_get_calibrated_min(6);
}
...
//  h                       i                       j                       k                       l                       m                       n                       o
    &H_unknown_input,       &H_unknown_input,       &H_unknown_input,       &H_autocalibrate_min,   &H_unknown_input,       &H_set_operating_mode1, &H_set_penguin_name,    &H_unknown_input,
//  p                       q                       r                       s                       t                       u                       v                       w
